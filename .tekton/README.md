...
To modify the pipelines for `guardrails-detectors` in the `rhoai-2.23-multi-arch-poc` release:
...
```bash
git commit -am "Update pipelinerun for guardrails-detectors (rhoai-2.23-multi-arch-poc)"
